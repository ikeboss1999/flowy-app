    ...
    return (
        <div ref={ref} style={{
            ...
            <div style={{ marginBottom: '30px' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
                    <div>
                        <div style={{ marginBottom: '8px' }}><span style={{ fontWeight: 'bold', width: '130px', display: 'inline-block' }}>SVA-Nr.:</span> {employee.personalData.socialSecurityNumber?.startsWith('gcm:v1:') ? 'nicht verfügbar' : (employee.personalData.socialSecurityNumber || 'nicht angegeben')}</div>
                    </div>
                    <div>
