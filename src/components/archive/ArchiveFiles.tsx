                    ...
                    <div className="bg-white rounded-[24px] p-8 w-full max-w-md shadow-2xl">
                        ...
                        <div className="space-y-2 mt-4 max-h-60 overflow-y-auto">
                            {allFolders.filter(f => f !== movingFile.folder).map(f => (
                                <button key={f} onClick={() => handleMoveFile(movingFile, f)} className="w-full text-left px-4 py-3 hover:bg-indigo-50 rounded-xl font-bold text-slate-700 border border-slate-100 flex items-center gap-3 font-outfit">
