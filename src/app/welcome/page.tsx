...
export default function WelcomePage() {
    return (
        <div className="min-h-screen bg-[#020205] text-white selection:bg-indigo-500/30 overflow-x-hidden">
            ...
            {/* Navigation */}
            <nav className="relative z-50 flex items-center justify-between px-8 py-6 max-w-7xl mx-auto backdrop-blur-md bg-white/[0.02] border-b border-white/5 sticky top-0">
                ...
                <div className="flex items-center gap-6">
                    ...
                    <Link href="/login?mode=register" className="bg-white text-black px-6 py-2.5 rounded-xl text-sm font-black hover:bg-white/90 transition-all hover:scale-105 active:scale-95 shadow-xl shadow-white/10">
                        Jetzt Starten
                    </Link>
                </div>
            </nav>
            ...
            <section className="relative z-10 pt-32 pb-20 px-6">
                <div className="max-w-7xl mx-auto text-center">
                    ...
                    <h1 className="text-7xl md:text-8xl font-black tracking-tight leading-[1.3] mb-8 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-100">
                        Die Zukunft des <br />
                        <span className="inline-block py-4 px-2 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 bg-clip-text text-transparent">Baugewerbes</span>
                    </h1>
                    <p className="text-xl md:text-2xl text-white/50 max-w-3xl mx-auto leading-relaxed mb-12 animate-in fade-in slide-in-from-bottom-12 duration-700 delay-200">
                        Verwalten Sie Rechnungen, Projekte und Mitarbeiter an einem zentralen Ort.
                        Modern, blitzschnell und für Profis entwickelt.
                    </p>
                    ...
                    <div className="flex flex-col items-center gap-12 animate-in fade-in slide-in-from-bottom-16 duration-700 delay-300">
                        ...
                        <div className="flex flex-col md:flex-row items-center justify-center gap-6 w-full">
                            <Link href="/login?mode=register" className="group bg-gradient-to-r from-indigo-600 to-purple-600 px-10 py-5 rounded-[2rem] text-xl font-black flex items-center gap-3 shadow-2xl shadow-indigo-500/20 transition-all hover:scale-105 active:scale-95">
                                Kostenlos Registrieren <ArrowRight className="h-6 w-6 group-hover:translate-x-1 transition-transform" />
                            </Link>
                            <Link href="/login" className="bg-white/5 backdrop-blur-xl border border-white/10 px-10 py-5 rounded-[2rem] text-xl font-black hover:bg-white/10 transition-all hover:scale-105 active:scale-95">
                                Zum Login
                            </Link>
                        </div>
            ...
            <section className="relative z-10 py-32 px-6">
                <div className="max-w-4xl mx-auto rounded-[3rem] bg-indigo-600 shadow-2xl shadow-indigo-600/20 p-16 text-center relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        <h2 className="text-5xl font-black mb-6">Bereit für den nächsten Schritt?</h2>
                        ...
                        <Link href="/login?mode=register" className="bg-white text-black px-12 py-5 rounded-2xl text-xl font-black hover:bg-white/90 transition-all hover:scale-105 active:scale-95 inline-block">
