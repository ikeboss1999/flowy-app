...
export default function OrdersPage() {
    ...
    if (isLoading) return <div className="p-10 text-slate-400 font-bold">Laden...</div>;
            ...
            <div className="flex justify-between items-end">
                <div className="space-y-2">
                    ...
                    <h1 className="text-5xl font-black text-slate-900 tracking-tight font-outfit">
                        Aufträge <span className="text-slate-300 font-light">Bestätigt</span>
                    </h1>
                    <p className="text-xl text-slate-500 font-medium">Alle Auftragsbestätigungen im Überblick.</p>
                </div>
